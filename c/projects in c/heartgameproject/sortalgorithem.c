...
static ADTErr CheckParameters(Vector* _vec , size_t _numOfElements)
{
	if (NULL == _vec)
	{
...
/******************************************************************************/
static void SwapArray(int* _array ,size_t _i ,size_t _j)
{	
	int temp;
	temp= _array[_i];
	_array[_i]=	_array[_j];
...
/******************************************************************************/
static int StartToEnd(Vector* _vec, size_t _index , int _stopPoint)
{
	int n1, n2 , flag;
	flag=0;
...
/******************************************************************************/
static int endToStart(Vector* _vec, size_t _index , int _stopPoint)
{
	int n1, n2 , flag;
	flag=0;
...
/******************************************************************************/
static size_t Partition (Vector*_vec, size_t _startIndex , size_t _endIndex)
{
...
ADTErr QuickSort (Vector* _vec , size_t _startIndex , size_t _endIndex)
{
	...
	if (_startIndex < _endIndex)
	{
		...
		if(posOfPivot >= 1)
		{	
			QuickSort (_vec , _startIndex , posOfPivot-1);
		}  
		QuickSort (_vec , posOfPivot +1 , _endIndex);
	}
...
/******************************************************************************/
ADTErr Shell(int *_array , size_t _numOfElements)
{
	int gap;
	size_t i, j;
...
/******************************************************************************/
ADTErr Selection (int* _array, size_t _numOfElements)
{
	size_t i, j;
	int  minIndex;
...
/******************************************************************************/
static ADTErr MergeArray(Vector* _vec,int* _tempArray, size_t _leftIndex ,size_t _rightIndex)
{
...
/******************************************************************************/
static void RecMergeArray(Vector* _vec,int* _tempArray,size_t _leftIndex ,size_t _rightIndex)
{
	size_t mid;
...
/******************************************************************************/
/******************************************************************************/
static void FreqOfElements(Vector* _vec, size_t* _countArray, size_t _itemsNum,int _digitPlace )
{
	size_t  index;
	int value;	
...
/******************************************************************************/
static void Cumolate(size_t* _countArray, int _maxValue)
{
	int index ;
...
/******************************************************************************/
ADTErr RadixSort(Vector* _vec, int _maxNumOfDigits)
{
	int digitPlace;
	int index;
